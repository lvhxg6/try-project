package com.g6.coder.rabbitmq.config;
...
public class RabbitConfig {
    ...
    public ConnectionFactory connectionFactory() {
        ...
        connectionFactory.setAddresses("192.168.10.188:5672");
        connectionFactory.setUsername("hx");
        connectionFactory.setPassword("ultrasafe");
